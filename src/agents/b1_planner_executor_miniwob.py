...
EXECUTOR_SYSTEM_PROMPT = (
    ...
    "If the element list is UNCHANGED after your action, the action had no "
    "effect. Do NOT repeat it. Stop and report that it did not work and what "
    "stayed the same, so a different approach can be chosen.\n"
